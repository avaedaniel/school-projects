...
class ParticipantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create participant" do
    assert_difference("Participant.count") do
      post participants_url, params: { participant: { name: @participant.name, trip_id: @participant.trip_id, user_id: @participant.user_id } }
    end
  ...
  test "should update participant" do
    patch participant_url(@participant), params: { participant: { name: @participant.name, trip_id: @participant.trip_id, user_id: @participant.user_id } }
